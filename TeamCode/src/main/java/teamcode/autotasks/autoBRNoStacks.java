...
import teamcode.vision.TrianglynotDuckyVisionBR;
import teamcode.vision.TrianglynotDuckyVisionBR.triangleLocation;


@Autonomous(name="IMUBRNoStacks")
public class autoBRNoStacks extends LinearOpMode {
...
//        arm.setPower(0);
        ...
        visionSystem = new TrianglynotDuckyVisionBR(this);
